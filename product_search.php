...
$db = new Database();
    ...
    if (($keyword == '') || (is_numeric($keyword))) {
        ...
        $get_prd = $db->prepare("SELECT * FROM `product_add` WHERE `prd_name` like '%$keyword%' ORDER BY `prd_id` asc ");
        $get_prd->execute();
                ...
                <?php foreach ($all_prd as $fet_product) { ?>
                    ...
                    <div class="col-md-3 top_brand_left">
                        <div class="hover14 column">
                            <a href="view_product.php?73ce347c9ef8a7b158b4529673bf67ff=<?php echo $fet_product['prd_id']; ?>&534ec62ce4097791f3273f229ef5803c
